...
$(document).ready(function(){
  ...
  $("body").append("<center><font size='5'>Powered by <a href='https://github.com/zhblue/hustoj'>HUSTOJ</a></font></center><br>")*/
  //$("body").append("<div align='center'><img src='http://www.hit-counts.com/counter.php?t=MTQ2MzgxMw==' border='0' alt='hit-counts'></div>");
  $("body").append("<center>Your IP is <?php echo get_ip(); ?>.</center><br>");
