    ...
    <nav class="navbar navbar-default" role="navigation">
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          ?>
            ...
            ?>
              ...
              <li>
                <a href="<?php echo $path_fix?>problemlist.php"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <?php echo $MSG_PROBLEMLIST?></a>
              ...
              <li <?php if ($url=="contest.php"||$url=="contest.php?my") echo " $ACTIVE";?>>
		<a href="<?php echo $path_fix?>contest.php<?php if(isset($_SESSION[$OJ_NAME."_user_id"])) echo "?my"  ?>"><span class="glyphicon glyphicon-fire" aria-hidden="true"></span> <?php echo $MSG_CONTEST?></a>
	      ...
	      <li <?php if ($url=="balloon.php") echo " $ACTIVE";?>>
                <a href="<?php echo $path_fix?>balloon.php"><span class="glyphicon glyphicon-cloud" aria-hidden="true"></span> <?php echo $MSG_BALLOON?></a>
	      </li>
	      <?php } ?>
              -->
              <?php if (isset($_SESSION[$OJ_NAME.'_'.'user_id'])) { ?>
              <li>
	        <a href="<?php echo $path_fix?>file"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> <?php echo $MSG_FILE?></a>
	      </li>
	      <?php } ?>
	      
	      <li>
		<a href="/tools.php"><span class="glyphicon glyphicon-link"></span> 工具</a>
	      </li>
              <?php if (isset($_SESSION[$OJ_NAME.'_'.'administrator'])) { ?>
              <li>
                <a href="<?php echo $pathfix?>admin"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> <?php echo $MSG_ADMIN?></a>
	      </li>
              <?php } ?>
              <!--
              <li>
                <a href="/NGGYU.php"><span class="glyphicon glyphicon-headphones" aria-hidden="true"></span> NGGYU</a>
              </li>
              -->
          <?php
            }
...
-->
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
	    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php if (isset($_SESSION[$OJ_NAME.'_'.'user_id'])) { ?><span class="glyphicon glyphicon-user"></span> <?php } ?><span id="profile">Login</span><span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
