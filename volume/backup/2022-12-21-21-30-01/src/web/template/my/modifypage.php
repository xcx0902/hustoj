...
<body>
  <div class="container">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4"><input name="template" class="form-control" type="text"></div>
	</div>
	 <?php } ?>
	<div class="form-group">
          <label class="col-sm-4 control-label"><?php echo $MSG_REFRESH_PRIVILEGE?></label>
	  <div class="col-sm-4"><a href="./refresh-privilege.php" class="btn btn-default btn-block"><?php echo $MSG_REFRESH_PRIVILEGE?></a></div>
        </div>
