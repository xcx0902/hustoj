...
if($template!=""&&($template=="syzoj"||$template=="my")){
	shell_exec("bash /home/judge/src/web/set_template.sh $OJ_TEMPLATE $template");
#	header("Location: /set_template.php?template=$template");
}
header("Location: ./");
?>
