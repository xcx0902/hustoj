...
if(isset($OJ_REG_NEED_CONFIRM)&&$OJ_REG_NEED_CONFIRM){
	$sql="INSERT INTO mail(to_user,from_user,title,content,in_date) values(?,?,?,?,now())";
	pdo_query($sql,"admin","user_reg","Registration Confirm Reminding","$user_id registered an account on $OJ_NAME, please confirm it ASAP.");
}
if(!isset($OJ_REG_NEED_CONFIRM)||!$OJ_REG_NEED_CONFIRM){
