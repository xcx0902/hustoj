...
static 	$DB_PASS="mROJXLY0cHk6FXMX";  //数据库密码

static 	$OJ_NAME="GXOJ";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
...
static  $OJ_CSS="hznu.css";  // bing.css kawai.css black.css blue.css green.css hznu.css
...
if (!isset($_SESSION[$OJ_NAME.'_administrator']) && get_ip() != "49.77.74.68") {
$OJ_VCODE=true;  //验证码
} else {
$OJ_VCODE=false;
}
...
static  $OJ_TEMPLATE="my"; //使用的默认模板,template目录下的每个子目录都是一个模板, [bs3 mdui sweet my mario bshark] work with discuss3
...
static  $OJ_DOWNLOAD=true; //是否允许下载WA的测试数据
...
static  $OJ_RANK_HIDDEN="'zhblue'";  // 管理员不显示在排名中
